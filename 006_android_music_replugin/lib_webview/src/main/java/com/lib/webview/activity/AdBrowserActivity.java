package com.lib.webview.activity;
...
import com.lib.webview.adbrowser.AdBrowserLayout;
import com.lib.webview.adbrowser.AdBrowserWebViewClient;
import com.lib.webview.adbrowser.Base64Drawables;
import com.lib.webview.adbrowser.BrowserWebView;
import com.lib.webview.utils.Utils;
...
public final class AdBrowserActivity extends Activity {
     ...
     * Data
     */
    @Autowired(name = KEY_URL) // 1、变量初始化，获取传过来的参数，并重命名，变量不能是private
    ...
    public final void onCreate(Bundle bundle) {
        ...
        //添加到arouter中
        ARouter.getInstance().inject(this); // 2、要进行inject才能获取参数
